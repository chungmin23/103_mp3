...
#ifndef _HAL_VS1003B_H_
#define _HAL_VS1003B_H_
...
/* ÃüÁîÆ¬Ñ¡ */
#define MP3_RESET(x) x ? HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET) : HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_RESET)

#define MP3_CCS(x) x ? HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET) : HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET)

#define MP3_DCS(x) x ? HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET) : HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET)

#define MP3_DREQ HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_2)
